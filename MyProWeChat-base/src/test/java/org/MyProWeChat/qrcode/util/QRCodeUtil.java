...
//      String fileName = new Random().nextInt(99999999) + "." + FORMAT.toLowerCase();
        ...
        fileName.append(DateUtils.getDate(DateUtils.DATE_FORMAT_ONETYPE + DateUtils.DATE_FORMAT_TWOTYPE));
        fileName.append(new Random().nextInt(99999999));
        fileName.append(".");
        fileName.append(FORMAT.toLowerCase());
